                    ...
                    >
                        ...
                        <div className="bg-primary inline-block rounded-xl px-8 py-4 shadow-xl shadow-primary/10">
                            <h1 className="text-white font-bold leading-tight text-3xl lg:text-4xl uppercase tracking-tight">
                                Good Corporate Governance <span className="italic font-medium opacity-80">(GCG)</span>
                            </h1>
                        </div>
                    </motion.div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
                        ...
                        >
                            <h3 className="text-2xl font-bold text-black border-l-4 border-secondary pl-6 italic">
                                Pilar Pertumbuhan dan Kepercayaan Stakeholders
                            </h3>
                            <div className="text-grey leading-relaxed text-justify space-y-4 text-base lg:text-lg">
                                <p>
                                    Saat ini, <span className="font-bold text-primary">Good Corporate Governance (GCG)</span> dan Corporate Social Responsibility (CSR) diakui sebagai bagian penting untuk menjamin pertumbuhan perusahaan secara berkelanjutan serta membangun kepercayaan dari para pemangku kepentingan, termasuk Lenders, Bank, dan Investor.
                                </p>
                                <p>
                                    GCG merupakan sistem yang mengatur mekanisme <span className="italic">check and balances</span> pengelolaan perusahaan sehingga proses bisnis beroperasi secara efisien, menguntungkan, dan tumbuh secara berkelanjutan (sustainable).
                                </p>
                                <p className="font-medium text-primary bg-primary/5 p-6 rounded-2xl border-dashed border-2 border-primary/20">
                                    Melalui transformasi GCG yang disinergikan dengan CSR, perusahaan hadir sebagai Good Corporate Citizen dengan pendekatan Triple Bottom Line (Profit, People, dan Planet) sebagai sarana pencapaian daya saing sesuai ekspektasi stakeholders.
                                </p>
                            </div>
                        </motion.div>
